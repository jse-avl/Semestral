...
function fetchPopularSeries($genreId = null,$page = 1) {
    $url = "https://api.themoviedb.org/3/discover/tv?language=es-ES&sort_by=popularity.desc&page=$page";
...
function getSerieById($serieId) {
    // 🆕 Agregamos append_to_response=videos para incluir los trailers
    $url = "https://api.themoviedb.org/3/tv/$serieId?language=es-ES&append_to_response=videos";
